...
namespace OrderInvoiceCheck
{
    ...
    public class MyCodedWorkflowActivity : System.Activities.Activity
    {
        public MyCodedWorkflowActivity()
        {
            this.Implementation = () =>
            {
                return new MyCodedWorkflowActivityChild()
                {};
            };
        }
    }

    internal class MyCodedWorkflowActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public MyCodedWorkflowActivityChild()
        {
            DisplayName = "MyCodedWorkflow";
        }
        ...
        {
            var codedWorkflow = new global::OrderInvoiceCheck.MyCodedWorkflow();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "MyCodedWorkflow.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "MyCodedWorkflow.cs", Exception = exception});
                }
